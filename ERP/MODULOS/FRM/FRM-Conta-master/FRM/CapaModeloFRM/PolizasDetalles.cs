...
namespace CapaModeloCONTA
{
	...
	{
		sql_PolizasDetalles Diario = new sql_PolizasDetalles();
		public void crearPolizasDetalles(string id, string empresa, string fecha) {
		...
		public void crearDetallePolizasDetalles(string mov, string libro, string partida, string cuenta, string debe, string haber)
		{
		...
		public void ModificarPolizasDetalles(string id, string empresa, string fecha, string estado)
		{
		...
		public OdbcDataAdapter llenarPolizasDetalles()
		{
			OdbcDataAdapter dataTable = Diario.LlenarTablaDiarioEncabezado();
			return dataTable;
		}
		public OdbcDataAdapter llenarPolizasDetalles2()
		{
			OdbcDataAdapter dataTable = Diario.LlenarTablaPolizaEncabezado();
			return dataTable;
		}
		public OdbcDataAdapter llenarPolizasDetalles3(string id)
		{
			OdbcDataAdapter dataTable = Diario.LlenarTablaPolizaDetalles(id);
			return dataTable;
		}
